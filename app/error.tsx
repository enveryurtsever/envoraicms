...
export default function ErrorPage({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="py-20 text-center">
      ...
      <h1 className="mt-3 text-3xl font-bold text-neutral-900 md:text-4xl">Something went wrong</h1>
      ...
      <div className="mt-6 flex items-center justify-center gap-3">
        ...
        <Link
          href="/"
          className="rounded border border-neutral-300 px-5 py-2.5 text-sm font-semibold text-neutral-700 hover:border-brand hover:text-brand"
        >
          Back to Home
        </Link>
      </div>
